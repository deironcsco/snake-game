...
int main() {
    ...
    int counterhead{ 0 }; //gotta test the 180 turn bug
        ...
        if (start_game && !game_over && !win_game) {
            ...
            if (curr.asSeconds() >= 0.5 ) {  //.2
                ...
                if (!direction_queue.empty()) {
                    ...
                    else if (direction_queue.front() == "right" || direction_queue.front() == "down") {
                        std::cout << "right, down\n";
                    ...
                    else if (direction_queue.front() == "left" || direction_queue.front() == "up") {
                        std::cout << "left, up\n";
                        std::cout << "head: " << snake[0].getPosition().x << ", " << snake[0].getPosition().y << "\n";
                        std::cout << "head offset: " << snake[0].getPosition().x-isquare_size << ", " << snake[0].getPosition().y-isquare_size << "\n";
                        std::cout << "2nd: " << snake[1].getPosition().x << ", " << snake[1].getPosition().y << "\n";
                ...
                if (snake.size() != 1) {
                        counterhead++;
                        std::cout << counterhead << "\n";
                        std::cout << "dir" << direction << "\n";
                        std::cout << "head: x " << snake[0].getPosition().x << " y " << snake[0].getPosition().y << "\n";
                        std::cout << "2nd: x " << snake[1].getPosition().x << " y " << snake[1].getPosition().y << "\n";
                }
